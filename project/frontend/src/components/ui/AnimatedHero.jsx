      ...
      <div className="container mx-auto">
        <div className="flex gap-8 py-20 lg:py-40 items-center justify-center flex-col">
            ...
            <h1 className="text-5xl md:text-7xl max-w-2xl tracking-tighter text-center font-regular">
              ...
              <span className="relative flex w-full justify-center overflow-hidden text-center md:pb-4 md:pt-1 h-20 md:h-28">
                ...
                {titles.map((title, index) => (
                  <motion.span
                    key={index}
                    className="absolute font-semibold bg-gradient-to-r from-fuchsia-600 to-cyan-600 bg-clip-text text-transparent"
          ...
          <div className="flex flex-row gap-3">
            ...
            <Button
              size="lg"
              className="gap-4 bg-gradient-to-r from-cyan-600 to-fuchsia-600 text-white border-0 hover:opacity-90"
            >
